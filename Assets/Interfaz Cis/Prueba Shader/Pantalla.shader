...
Shader "Miguel/Pantalla"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_Roughness("Roughness", 2D) = "gray" {}
		[HDR]_Emisivo("Emisivo", 2D) = "white" {}
		[HDR]_ColorEmisivo("ColorEmisivo", Color) = (0,0,0,0)
		_DistanciaBorde("Distancia Borde", Float) = 1
		_EstadoPantalla("EstadoPantalla", Range( 1 , 6)) = 6
		_IntecidadBorde("Intecidad Borde", Float) = 1
		_1("1", 2D) = "white" {}
		_ColorBorde("Color Borde", Color) = (0,1,0.9907742,1)
		_2("2", 2D) = "white" {}
		_3("3", 2D) = "white" {}
		_4("4", 2D) = "white" {}
		_5("5", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _1_ST;
			float4 _Emisivo_ST;
			float4 _ColorEmisivo;
			float4 _ColorBorde;
			float4 _Roughness_ST;
			float _EstadoPantalla;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_6 = IN.ase_texcoord8.xy * _6_ST.xy + _6_ST.zw;
				float2 uv_5 = IN.ase_texcoord8.xy * _5_ST.xy + _5_ST.zw;
				float2 uv_4 = IN.ase_texcoord8.xy * _4_ST.xy + _4_ST.zw;
				float2 uv_3 = IN.ase_texcoord8.xy * _3_ST.xy + _3_ST.zw;
				float2 uv_2 = IN.ase_texcoord8.xy * _2_ST.xy + _2_ST.zw;
				float2 uv_1 = IN.ase_texcoord8.xy * _1_ST.xy + _1_ST.zw;
				
				float2 uv_Emisivo = IN.ase_texcoord8.xy * _Emisivo_ST.xy + _Emisivo_ST.zw;
				...
				float distanceDepth55 = abs( ( screenDepth55 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DistanciaBorde ) );
				float clampResult51 = clamp( ( ( 1.0 - distanceDepth55 ) * _IntecidadBorde ) , 0.0 , 1.0 );
				
				float2 uv_Roughness = IN.ase_texcoord8.xy * _Roughness_ST.xy + _Roughness_ST.zw;
				

				float3 BaseColor = ( _EstadoPantalla == (float)7 ? tex2D( _TextureSample0, uv_TextureSample0 ) : ( _EstadoPantalla == (float)6 ? tex2D( _6, uv_6 ) : ( _EstadoPantalla == (float)5 ? tex2D( _5, uv_5 ) : ( _EstadoPantalla == (float)4 ? tex2D( _4, uv_4 ) : ( _EstadoPantalla == (float)3 ? tex2D( _3, uv_3 ) : ( _EstadoPantalla == (float)2 ? tex2D( _2, uv_2 ) : tex2D( _1, uv_1 ) ) ) ) ) ) ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( ( tex2D( _Emisivo, uv_Emisivo ) * _ColorEmisivo ) + ( _ColorBorde * clampResult51 ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_6 = IN.ase_texcoord4.xy * _6_ST.xy + _6_ST.zw;
				float2 uv_5 = IN.ase_texcoord4.xy * _5_ST.xy + _5_ST.zw;
				float2 uv_4 = IN.ase_texcoord4.xy * _4_ST.xy + _4_ST.zw;
				float2 uv_3 = IN.ase_texcoord4.xy * _3_ST.xy + _3_ST.zw;
				float2 uv_2 = IN.ase_texcoord4.xy * _2_ST.xy + _2_ST.zw;
				float2 uv_1 = IN.ase_texcoord4.xy * _1_ST.xy + _1_ST.zw;
				
				float2 uv_Emisivo = IN.ase_texcoord4.xy * _Emisivo_ST.xy + _Emisivo_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_6 = IN.ase_texcoord2.xy * _6_ST.xy + _6_ST.zw;
				float2 uv_5 = IN.ase_texcoord2.xy * _5_ST.xy + _5_ST.zw;
				float2 uv_4 = IN.ase_texcoord2.xy * _4_ST.xy + _4_ST.zw;
				float2 uv_3 = IN.ase_texcoord2.xy * _3_ST.xy + _3_ST.zw;
				float2 uv_2 = IN.ase_texcoord2.xy * _2_ST.xy + _2_ST.zw;
				float2 uv_1 = IN.ase_texcoord2.xy * _1_ST.xy + _1_ST.zw;
...
/*ASEBEGIN
Version=19002
1528;7.2;1280;653;3205.119;1074.94;2.707163;True;False
Node;AmplifyShaderEditor.CommentaryNode;47;-2840.315,-1640.634;Inherit;False;2413.759;1439.064;Comment;20;43;31;36;35;23;34;33;39;27;21;28;38;41;26;32;19;25;24;30;37;Cambio Textura;1,1,1,1;0;0
Node;AmplifyShaderEditor.IntNode;38;-1360.695,-862.8565;Inherit;False;Constant;_Int4;Int 4;11;0;Create;True;0;0;0;False;0;False;6;0;False;0;1;INT;0
Node;AmplifyShaderEditor.Compare;37;-964.2375,-713.009;Inherit;False;0;4;0;FLOAT;0;False;1;INT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-2408.117,-1590.634;Inherit;False;Property;_EstadoPantalla;EstadoPantalla;4;0;Create;True;0;0;0;False;0;False;6;1;1;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;25;-1892.135,-436.3989;Inherit;True;Property;_4;4;10;0;Create;True;0;0;0;False;0;False;-1;9500f99fc05e13e4ca07fd77adb65f12;9500f99fc05e13e4ca07fd77adb65f12;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;54;-1649.609,465.3852;Inherit;False;Property;_DistanciaBorde;Distancia Borde;3;0;Create;True;0;0;0;False;0;False;1;0.003;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;32;-2194.316,-924.0255;Inherit;False;Constant;_Int1;Int 1;11;0;Create;True;0;0;0;False;0;False;3;0;False;0;1;INT;0
Node;AmplifyShaderEditor.SamplerNode;24;-2281.699,-436.8357;Inherit;True;Property;_3;3;9;0;Create;True;0;0;0;False;0;False;-1;c6724ad69cc3be14d8fab4724e614619;c6724ad69cc3be14d8fab4724e614619;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Compare;30;-2267.684,-697.9818;Inherit;False;0;4;0;FLOAT;0;False;1;INT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;56;-1119.34,464.3424;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;-1147.062,618.9255;Inherit;False;Property;_IntecidadBorde;Intecidad Borde;5;0;Create;True;0;0;0;False;0;False;1;5.07;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;50;-705.5671,301.4944;Inherit;False;Property;_ColorBorde;Color Borde;7;0;Create;True;0;0;0;False;0;False;0,1,0.9907742,1;0,1,0.9907742,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;51;-686.0588,488.2849;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;52;-423.9748,423.5173;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;53;-905.1838,503.671;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;26;-1506.594,-433.7782;Inherit;True;Property;_5;5;11;0;Create;True;0;0;0;False;0;False;-1;7ae704ac3162c6545ac1b11f02680a8b;7ae704ac3162c6545ac1b11f02680a8b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;41;-777.3752,-437.1927;Inherit;True;Property;_TextureSample0;Texture Sample 0;13;0;Create;True;0;0;0;False;0;False;-1;None;6e8c405676701474c8a5eb3a386a5a6b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;57;-8.445277,-9.364725;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.IntNode;28;-2612.777,-964.1442;Inherit;False;Constant;_Int0;Int 0;11;0;Create;True;0;0;0;False;0;False;2;0;False;0;1;INT;0
Node;AmplifyShaderEditor.ColorNode;12;-905.4549,83.77608;Inherit;False;Property;_ColorEmisivo;ColorEmisivo;2;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,6.939904,7.937255,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Compare;39;-674.3075,-722.1388;Inherit;False;0;4;0;FLOAT;0;False;1;INT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;17;-142.1364,537.5372;Inherit;True;Property;_Roughness;Roughness;0;0;Create;True;0;0;0;False;0;False;-1;None;b2ea0b51023bac341969bbf829eba751;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-640.0645,10.11741;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;21;-2790.315,-431.5701;Inherit;True;Property;_1;1;6;0;Create;True;0;0;0;False;0;False;-1;3619dcbb5349cb145945bf7448cfde8b;3619dcbb5349cb145945bf7448cfde8b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;36;-1610.281,-861.1064;Inherit;False;Constant;_Int3;Int 3;11;0;Create;True;0;0;0;False;0;False;5;0;False;0;1;INT;0
Node;AmplifyShaderEditor.OneMinusNode;16;211.0365,516.8561;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;27;-1152.032,-446.886;Inherit;True;Property;_6;6;12;0;Create;True;0;0;0;False;0;False;-1;89442caf8a49ced4dbbb3566553de5ca;89442caf8a49ced4dbbb3566553de5ca;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;43;-1150.447,-856.9427;Inherit;False;Constant;_Int5;Int 5;13;0;Create;True;0;0;0;False;0;False;7;0;False;0;1;INT;0
Node;AmplifyShaderEditor.DepthFade;55;-1434.34,494.3424;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;34;-1886.079,-867.5045;Inherit;False;Constant;_Int2;Int 2;11;0;Create;True;0;0;0;False;0;False;4;0;False;0;1;INT;0
Node;AmplifyShaderEditor.SamplerNode;23;-2785.83,-726.3039;Inherit;True;Property;_2;2;8;0;Create;True;0;0;0;False;0;False;-1;9136af3b1445f9e4f9bbf46c80339fa6;9136af3b1445f9e4f9bbf46c80339fa6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-991.5912,-143.8727;Inherit;True;Property;_Emisivo;Emisivo;1;1;[HDR];Create;True;0;0;0;False;0;False;-1;None;63aa35d5e801d894094d5ea1d5c5c1c1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Compare;33;-1547.489,-697.8041;Inherit;False;0;4;0;FLOAT;0;False;1;INT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Compare;31;-1865.5,-685.0199;Inherit;False;0;4;0;FLOAT;0;False;1;INT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Compare;35;-1223.217,-709.7534;Inherit;False;0;4;0;FLOAT;0;False;1;INT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=3D91620F9898ECCA7C1D911C12D5C7BCA60C5362