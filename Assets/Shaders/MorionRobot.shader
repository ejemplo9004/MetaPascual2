...
Shader "Morion/Robot"
{
	Properties
	{
		...
		[ASEBegin]_Difuso("Difuso", 2D) = "white" {}
		_Mascara("Mascara", 2D) = "white" {}
		[Normal]_Normales("Normales", 2D) = "bump" {}
		[HDR]_Emisivo("Emisivo", 2D) = "white" {}
		[HDR]_ColorEmisivo("ColorEmisivo", Color) = (0,0,0,0)
		_ColorPrincipal("ColorPrincipal", Color) = (0,0,0,0)
		[ASEEnd]_ColorSecundario("ColorSecundario", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Difuso = IN.ase_texcoord8.xy * _Difuso_ST.xy + _Difuso_ST.zw;
				float2 uv_Mascara = IN.ase_texcoord8.xy * _Mascara_ST.xy + _Mascara_ST.zw;
				float4 tex2DNode16 = tex2D( _Mascara, uv_Mascara );
				float4 color22 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				
				float2 uv_Normales = IN.ase_texcoord8.xy * _Normales_ST.xy + _Normales_ST.zw;
				
				float2 uv_Emisivo = IN.ase_texcoord8.xy * _Emisivo_ST.xy + _Emisivo_ST.zw;
				

				float3 BaseColor = ( tex2D( _Difuso, uv_Difuso ) * ( ( tex2DNode16.r * color22 ) + ( tex2DNode16.g * _ColorPrincipal ) + ( tex2DNode16.b * _ColorSecundario ) ) ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Normales, uv_Normales ), 1.0f );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Difuso = IN.ase_texcoord4.xy * _Difuso_ST.xy + _Difuso_ST.zw;
				float2 uv_Mascara = IN.ase_texcoord4.xy * _Mascara_ST.xy + _Mascara_ST.zw;
				float4 tex2DNode16 = tex2D( _Mascara, uv_Mascara );
				float4 color22 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Difuso = IN.ase_texcoord2.xy * _Difuso_ST.xy + _Difuso_ST.zw;
				float2 uv_Mascara = IN.ase_texcoord2.xy * _Mascara_ST.xy + _Mascara_ST.zw;
				float4 tex2DNode16 = tex2D( _Mascara, uv_Mascara );
				float4 color22 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Normales = IN.ase_texcoord4.xy * _Normales_ST.xy + _Normales_ST.zw;
...
/*ASEBEGIN
Version=19002
271.8;-852;1439;802;2005.673;1603.117;2.464514;True;False
Node;AmplifyShaderEditor.SamplerNode;12;-457.3034,36.36698;Inherit;True;Property;_Emisivo;Emisivo;3;1;[HDR];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;24;-327.8726,-602.3218;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-520.6729,-577.5218;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-514.2728,-694.3218;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;22;-850.2725,-598.3222;Inherit;False;Constant;_Color0;Color 0;7;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;18;-843.8706,-228.7209;Inherit;False;Property;_ColorSecundario;ColorSecundario;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;17;-848.6708,-409.5217;Inherit;False;Property;_ColorPrincipal;ColorPrincipal;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;16;-904.4269,-814.7747;Inherit;True;Property;_Mascara;Mascara;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-906.2692,-1059.245;Inherit;True;Property;_Difuso;Difuso;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-517.3729,-466.6223;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-19.75049,-782.863;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;14;-392.8243,231.5297;Inherit;False;Property;_ColorEmisivo;ColorEmisivo;4;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-105.9011,93.27142;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;11;-458.8725,-149.0334;Inherit;True;Property;_Normales;Normales;2;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;430.6657,-610.4343;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;11;Morion/Robot;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;41;Workflow;1;0;Surface;1;638033707598842617;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=D993DEE4E29133A5DC62A2A0C187B113A9372D32